...
Lumen 面向有持续阅读与技术学习需求的学习者，帮助他们阅读技术文档、书籍、论文、新闻、课程材料，以及开源面经、面试题和知识整理文档。
...
- 表达收藏、真实语境保存和原文跳转；
- 当前阅读范围内的自动 Recall；
- 导入时选择“英文阅读”或“技术学习”场景，两者共享文档、选区、对话和持久化底层；
- Reader 内常驻 AI 悬浮球与 Chatbot 面板，支持引用当前原文、连续提问和引用历史回答；
- 单一当前原文的解释型请求会生成持久化 AI 注脚，后续可从正文尾标快速恢复对应对话；
